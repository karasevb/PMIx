...
typedef pmix_status_t (*pmix_bfrop_odti_pack_fn_t)(pmix_pointer_array_t *regtypes,
                                                   pmix_buffer_t *buffer,
                                                   const void *src,
                                                   int32_t num_values,
                                                   pmix_data_type_t type);

typedef pmix_status_t (*pmix_bfrop_odti_unpack_fn_t)(pmix_pointer_array_t *regtypes,
 ...
 */
 typedef struct {
    ...
    char *odti_name;
    /** Pack function */
    pmix_bfrop_odti_pack_fn_t odti_pack_fn;
    /** Unpack function */
    pmix_bfrop_odti_unpack_fn_t odti_unpack_fn;
    /** copy function */
...
#define PMIX_REGISTER_TYPE(n, t, p, u, c, pr, arr)                  \
 do {                                                               \
    ...
    _info->odti_type = (t);                                         \
    _info->odti_pack_fn = (pmix_bfrop_odti_pack_fn_t)(p);           \
    _info->odti_unpack_fn = (pmix_bfrop_odti_unpack_fn_t)(u);       \
...
PMIX_EXPORT pmix_status_t pmix_bfrops_base_pack_iof_channel(pmix_pointer_array_t *regtypes,
                                                            pmix_buffer_t *buffer, const void *src,
                                                            int32_t num_vals, pmix_data_type_t type);
PMIX_EXPORT pmix_status_t pmix_bfrops_base_pack_envar(pmix_pointer_array_t *regtypes, pmix_buffer_t *buffer, const void *src,
                                                      int32_t num_vals, pmix_data_type_t type);
